...
if(CMAKE_SYSTEM_NAME MATCHES "Windows")
    # Windows 平台命令
    set(ANTLR_COMMAND "powershell.exe -Command \"java -jar '${tensorslow_dir}/jar/antlr-4.13.2-complete.jar' -Dlanguage=Cpp -visitor -o ${tensorslow_antlr4_generated_dir} '${tensorslow_antlr4_grammar_dir}/Python3Lexer.g4' '${tensorslow_antlr4_grammar_dir}/Python3Parser.g4'\"")
else()
    # Linux 或其他平台命令
    set(ANTLR_COMMAND "java -jar '${tensorslow_dir}/jar/antlr-4.13.2-complete.jar' -Dlanguage=Cpp -visitor -o ${tensorslow_antlr4_generated_dir} '${tensorslow_antlr4_grammar_dir}/Python3Lexer.g4' '${tensorslow_antlr4_grammar_dir}/Python3Parser.g4'")
endif()
