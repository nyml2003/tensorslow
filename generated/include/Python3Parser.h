...
class Python3Parser : public Python3ParserBase {
 public:
  ...
  enum {
    ...
    RuleExpr_stmt = 16,
    RuleAnnassign = 17,
    RuleTestlist_star_expr = 18,
    RuleAugassign = 19,
    RuleDel_stmt = 20,
    RulePass_stmt = 21,
    RuleFlow_stmt = 22,
    RuleBreak_stmt = 23,
    RuleContinue_stmt = 24,
    RuleReturn_stmt = 25,
    RuleYield_stmt = 26,
    RuleRaise_stmt = 27,
    RuleImport_stmt = 28,
    RuleImport_name = 29,
    RuleImport_from = 30,
    RuleImport_as_name = 31,
    RuleDotted_as_name = 32,
    RuleImport_as_names = 33,
    RuleDotted_as_names = 34,
    RuleDotted_name = 35,
    RuleGlobal_stmt = 36,
    RuleNonlocal_stmt = 37,
    RuleAssert_stmt = 38,
    RuleCompound_stmt = 39,
    RuleAsync_stmt = 40,
    RuleIf_stmt = 41,
    RuleWhile_stmt = 42,
    RuleFor_stmt = 43,
    ...
    RuleWith_stmt = 45,
    RuleWith_item = 46,
    RuleExcept_clause = 47,
    RuleBlock = 48,
    RuleMatch_stmt = 49,
    RuleSubject_expr = 50,
    RuleStar_named_expressions = 51,
    RuleStar_named_expression = 52,
    RuleCase_block = 53,
    RuleGuard = 54,
    RulePatterns = 55,
    RulePattern = 56,
    RuleAs_pattern = 57,
    RuleOr_pattern = 58,
    RuleClosed_pattern = 59,
    RuleLiteral_pattern = 60,
    RuleLiteral_expr = 61,
    RuleComplex_number = 62,
    RuleSigned_number = 63,
    RuleSigned_real_number = 64,
    RuleReal_number = 65,
    RuleImaginary_number = 66,
    RuleCapture_pattern = 67,
    RulePattern_capture_target = 68,
    RuleWildcard_pattern = 69,
    RuleValue_pattern = 70,
    RuleAttr = 71,
    RuleName_or_attr = 72,
    RuleGroup_pattern = 73,
    RuleSequence_pattern = 74,
    RuleOpen_sequence_pattern = 75,
    RuleMaybe_sequence_pattern = 76,
    RuleMaybe_star_pattern = 77,
    RuleStar_pattern = 78,
    RuleMapping_pattern = 79,
    RuleItems_pattern = 80,
    RuleKey_value_pattern = 81,
    RuleDouble_star_pattern = 82,
    RuleClass_pattern = 83,
    RulePositional_patterns = 84,
    RuleKeyword_patterns = 85,
    RuleKeyword_pattern = 86,
    RuleTest = 87,
    RuleTest_nocond = 88,
    RuleLambdef = 89,
    RuleLambdef_nocond = 90,
    RuleOr_test = 91,
    RuleAnd_test = 92,
    RuleNot_test = 93,
    RuleComparison = 94,
    ...
    RuleAtom = 99,
    RuleName = 100,
    RuleTestlist_comp = 101,
    RuleTrailer = 102,
    RuleSubscriptlist = 103,
    RuleSubscript_ = 104,
    RuleSliceop = 105,
    RuleExprlist = 106,
    RuleTestlist = 107,
    RuleDictorsetmaker = 108,
    RuleClassdef = 109,
    RuleArglist = 110,
    RuleArgument = 111,
    RuleComp_iter = 112,
  ...
  bool literal_patternSempred(
    Literal_patternContext* _localctx,
    size_t predicateIndex
  );
  bool
  literal_exprSempred(Literal_exprContext* _localctx, size_t predicateIndex);
  bool pattern_capture_targetSempred(
    Pattern_capture_targetContext* _localctx,
    size_t predicateIndex
  );
  bool
  value_patternSempred(Value_patternContext* _localctx, size_t predicateIndex);
